...
<body>
<%--   	<img alt="my image" src="<c:url value="/resources/image/tiger1.jpg" />"> --%>
    <div class="container text-center m-6" style="padding-top: 20px">
    	<h1>Oops! Sorry</h1>
    	<h2>${msg }</h2>
    	...
    	<div class="error-actions">
    		<a href="#!"><span></span>
    			Take me Home</a>
    		<a href="#!" class="btn btn-default btn-lg"><span>Contact Support</span></a>
    	</div>
